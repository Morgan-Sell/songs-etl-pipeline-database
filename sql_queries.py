...
songplay_table_create = ("""
    ...
    start_time TIME NOT NULL, user_id INT , level VARCHAR, song_id VARCHAR,
...
song_table_create = ("""
    ...
    title VARCHAR NOT NULL, artist_id VARCHAR, year INT, duration NUMERIC)
""")
...
time_table_create = ("""
    CREATE TABLE IF NOT EXISTS time (start_time TIME, hour INT, day INT, 
